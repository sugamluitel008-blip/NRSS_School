      ...
      <div className="p-4 sm:p-7 md:p-8 rounded-2xl sm:rounded-3xl bg-gradient-to-r from-slate-900 via-indigo-950/30 to-slate-900 border border-slate-800 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-xl">
        <div className="space-y-1">
          ...
          <div className="flex flex-wrap items-center gap-2 pt-2 text-xs">
            ...
            <span className="px-2.5 py-1 sm:py-0.5 rounded-md bg-amber-950/60 border border-amber-800/50 text-amber-300 font-medium flex items-center gap-1">
            ...
            <>
              ...
              {teachers.length > 0 && onClearAllTeachers && (
                <button
                  ...
                  className="w-full sm:w-auto px-3 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-rose-300 font-medium text-xs border border-slate-700 transition flex items-center justify-center gap-1.5"
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 bg-slate-900/60 p-3 rounded-2xl border border-slate-800">
        ...
        <div className="relative w-full sm:w-72 shrink-0">
          ...
          <input
            ...
            className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-9 pr-3 py-2.5 sm:py-2 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-indigo-500 transition"
          />
        </div>
      </div>
